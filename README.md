...
Este proyecto es una API RESTful construida con FastAPI que implementa un Agente de Procesamiento de Documentos Inteligente (IDP). Su función principal es clasificar y extraer datos estructurados de documentos de Recursos Humanos, como Currículums Vitae (CV) y Cédulas de Identidad (CI/DNI), utilizando técnicas avanzadas de Prompt Engineering y modelos de lenguaje de gran escala (GPT-5).
...
La aplicación opera bajo un Modo Híbrido de Análisis para maximizar la velocidad y la precisión, adaptándose dinámicamente al tipo de documento y la calidad de entrada.
...
{
  "tipo_documento": "CI",
  "resumen": "Cédula de Identidad de Alejandro Olguin, ciudadano boliviano, nacido el 15/05/2000 (24 años). Documento emitido en Chuquisaca.",
  "datos_cv": null,
  "datos_ci": {
...
Desarrollado por Alejandro Olguin